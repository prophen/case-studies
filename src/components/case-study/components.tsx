...
export function VideoEmbed({ videoId, caption }: { videoId: string; caption: string }) { return <figure className="video-embed"><div className="video-frame"><iframe src={`https://www.youtube-nocookie.com/embed/${videoId}`} title="Project walkthrough video" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen /></div><figcaption>{caption}</figcaption></figure>; }
